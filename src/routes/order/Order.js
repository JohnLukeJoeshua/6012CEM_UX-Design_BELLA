...
const Order = ({ orderFormValue, cartItems, selectedCurrency, clearCart }) => {
    ...
    useEffect(() => {
        document.title = "Order summary | BELLA";
    }, []);
    ...
    return (
        <main className="order">
            ...
            <section className="order-success">
                ...
                <p>
                    Your order has been received successfully at BELLA. We're thrilled that you've chosen us for your fashion needs. Your style journey is about to begin!
                </p>
                <h3> Order Details:</h3>
